...
const AUTH_BTN_STYLE: React.CSSProperties = {
  display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.65rem',
  width: '100%', minHeight: '48px', padding: '0.85rem 1rem',
      ...
      {sent ? (
        ...
        <>
          <div style={{ width: '100%', maxWidth: '320px', display: 'flex', flexDirection: 'column', gap: '0.6rem' }}>
            ...
            <button onClick={handleAppleSignIn} disabled={appleLoading} style={{ ...AUTH_BTN_STYLE, opacity: appleLoading ? 0.5 : 1 }}>
              <svg width="16" height="19" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
            ...
            {/* Google */}
            <button onClick={handleGoogleSignIn} style={AUTH_BTN_STYLE}>
          ...
          <div style={{ width: '100%', maxWidth: '320px', marginTop: '1.5rem' }}>
            ...
            <button onClick={handleEmailSubmit} style={{ ...AUTH_BTN_STYLE, width: '100%', marginTop: '0.6rem' }}>
          ...
          <p style={{ fontSize: '0.75rem', color: 'var(--text-3)', textAlign: 'center', maxWidth: '320px', margin: '1.25rem 0 0', lineHeight: 1.7 }}>
...
function clearLocal() {
  ...
  localStorage.removeItem('ronin_hesitated')
